...
class EmpresasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create empresa" do
    assert_difference("Empresa.count") do
      post empresas_url, params: { empresa: { cnpj: @empresa.cnpj, endereco: @empresa.endereco, id_empresa: @empresa.id_empresa, nome: @empresa.nome, telefone: @empresa.telefone } }
    end
  ...
  test "should update empresa" do
    patch empresa_url(@empresa), params: { empresa: { cnpj: @empresa.cnpj, endereco: @empresa.endereco, id_empresa: @empresa.id_empresa, nome: @empresa.nome, telefone: @empresa.telefone } }
