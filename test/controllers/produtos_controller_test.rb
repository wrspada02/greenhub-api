...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference("Produto.count") do
      post produtos_url, params: { produto: { id_produto: @produto.id_produto, peso: @produto.peso, tipo: @produto.tipo } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { id_produto: @produto.id_produto, peso: @produto.peso, tipo: @produto.tipo } }
